let list_data = [
  
  {
    ...
    date: '2018-12-12',
    title: '教育理念',
    detail_img: '/static/detail/swiper/04.jpg',
    avatar: '/static/avatar/4.png',
    detail_content: '让每一个 IT 为了方便妻子草壁靖子养病，草壁达郎决定带着两个女儿草壁皋月和草壁梅搬到草壁靖子所在疗养院附近的乡下，父女三人入住了一间年久失修的老房子。小姐妹俩很快发现看似平凡无奇的乡下有很多神奇的事物，无人居住的房屋里能聚能散还能飞的“煤灰”、森林里的小精灵、森林的主人龙猫和笑口常开的猫巴士。',
    headImgSrc: '/static/detail/carousel/02.jpg',
    author: '钢铁侠 ',
    dataTime: '24time',
    detail_love_image1: '/static/icon/chat.png',
    detail_love_image2: '/static/icon/view.png',
    isLove: 1,
    love_count: 88,
    attention_count: 66,
    detail: '钢铁战队。。',
    music: {
      dataUrl: 'https://music.163.com/#/song?id=28285910&market=baiduqk', // 音乐链接
      title: '岁月神偷',   // 音乐标题
  ...
  },
  {
    ...
    date: 'may 19 2018',
    title: '尚硅谷',
    detail_img: '/static/detail/carousel/01.jpg',
    avatar: '/static/avatar/4.png',
    ...
    headImgSrc: '/static/detail/carousel/01.jpg',
    author: '美国队长',
    dataTime: '24time',
    detail_love_image1: '/static/icon/chat.png',
    detail_love_image2: '/static/icon/view.png',
  ...
  },
  {
    ...
    date: 'may 19 2018',
    title: '学科介绍',
    detail_img: '/static/detail/carousel/03.jpg',
    avatar: '/static/avatar/4.png',
    ...
    headImgSrc: '/static/detail/carousel/03.jpg',
    author: '绿巨人',
    dataTime: '24time',
    detail_love_image1: '/static/icon/chat.png',
    detail_love_image2: '/static/icon/view.png',
  ...
  },
  {
    ...
    title: '贾静雯简介',
    detail_img: '/static/detail/list/j2.jpg',
    ...
    isLove: 1,
    love_count: 92,
    headImgSrc: '/static/detail/list/j2.jpg',
    author: '新华社',
    attention_count: 88,
  ...
  },
  {
    ...
    title: '贾静雯作品展',
    detail_img: '/static/detail/list/j3.jpg',
    ...
    love_count: 88,
    attention_count: 66,
    headImgSrc: '/static/detail/list/j3.jpg',
    author: '新华社',
  ...
  },
  {
    ...
    date: 'sep 19 2016',
    title: '娱乐新闻',
    detail_img: '/static/detail/list/j4.jpg',
    ...
    headImgSrc: '/static/detail/list/j4.jpg',
    author: '李白3',
    detail_love_image1: '/static/icon/chat.png',
    detail_love_image2: '/static/icon/view.png',
    isLove: 1,
